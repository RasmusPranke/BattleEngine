...
class OutlineCam:
    '''def __init__(self, maxCount \'''For how many blocks outlines may be saved\'''):
...
class CubeRender:
    ...
    def __init__(self, maxCount):
        ...
        #As such, each cube requires 3 * 4 = 12 vertices for the sides, plus another 12 for the outlines for better visibility.
        self.vertexMult = 3 * 4
        ...
        self.outlineList = pyglet.graphics.vertex_list(maxCount * self.vertexMult,
                                             ('v2f/stream', [0 for x in range(maxCount * self.coordinateMult)]),
                                             ('c4B/stream', [0 for x in range(maxCount * self.colorMult)]))
        self.xOff = 0
        self.yOff = 0
    ...
    def adjustAllPos(self, xAdjust, yAdjust):
        ...
        self.outlineList.vertices = posList    
    ...
    def setPosition(self, index, x, y, z):
        ...
        self.outlineList.vertices[basePos:basePos + self.coordinateMult] = newPosList
    ...
    def draw(self):
        ...
        if self.outlineList is not None:
            pass
            #self.outlineList.draw(pyglet.gl.GL_LINES)
        else:
            print("Outline List not yet initialized!")
